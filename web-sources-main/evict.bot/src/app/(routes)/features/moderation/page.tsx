        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0A0A0B] to-black">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12 md:mb-20">
                    {[
                        {
                            icon: <Shield className="w-6 h-6 text-evict-primary" />,
                            title: "Auto-Moderation",
                            description:
                                "Automatically detect and handle spam, inappropriate content, and raids"
                        },
                        {
                            icon: <MessageSquare className="w-6 h-6 text-evict-primary" />,
                            title: "Message Filtering",
                            description:
                                "Filter unwanted content, links, and attachments with customizable rules"
                        },
                        {
                            icon: <UserX className="w-6 h-6 text-evict-primary" />,
                        ...
                        {
                            icon: <AlertTriangle className="w-6 h-6 text-evict-primary" />,
                            title: "Raid Protection",
                            description: "Advanced algorithms to detect and prevent raid attempts"
                        },
                        {
                            icon: <Ban className="w-6 h-6 text-evict-primary" />,
                                        ...
                                        {tabs.map(tab => (
                                            <motion.button
                                                ...
                                                className={`flex items-center gap-2 px-4 py-3 text-sm font-medium transition-colors
                                                    ${
                                                        activeTab === tab.key
                                                            ? "text-white border-b-2 border-evict-primary"
                                            ...
                                            <motion.div
                                                ...
                                                <div className="bg-black/20 rounded-lg p-3">
                                                    <div className="flex items-center justify-between mb-2">
                                                        ...
                                                        <span className="text-sm font-medium text-evict-primary">
                                                            {selectedPreset === "strict"
                                                                ? "98%"
                                                                : selectedPreset === "medium"
                                                                  ? "85%"
                                                    ...
                                                    <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                                                        <motion.div
                                                            ...
                                                            className="h-full rounded-full bg-evict-primary"
                                                        />
                                                    </div>
                                                </div>
                                            </motion.div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                <div className="text-evict-primary/60 font-bold mb-2">
                                    Step {step.step}
                                </div>
                                <h3 className="text-xl font-semibold text-evict-primary mb-2">
                                    {step.title}
                                </h3>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-8 mt-8">
                            <div className="flex-1 space-y-4">
                                <p className="text-white/60 text-xl">
                                    Join thousands of servers already using Evict&apos;s moderation
                                    system
                                </p>
