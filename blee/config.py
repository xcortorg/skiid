...
class Bleed:
    token = "MTI4ODc0ODQyODcyMTEzMTU1MQ.G_RmrG.E5jYX5G8z44Dqkg1jlq7hMeyPVOwCJtZY2J5Gs"
    prefix = ","
    owner_id = [1247076592556183598, 1301808966782947328]
...
class LAVALINK:
    ...
    HOST: str = "0.0.0.0"
    PORT: int = 2333
    PASSWORD: str = "3o8RHRo0or0aMyCLf0HBHTpfgjcQ1S8zpOgnMMhhF7FACSNJpMU"
