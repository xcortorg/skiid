...
class InstagramHandler:
    def __init__(self, session: aiohttp.ClientSession):
        ...
        self.cookies = {
            'sessionid': os.getenv('INSTAGRAM_SESSION_ID', '74709283824%3ANmmReaXdYE1u4G%3A14%3AAYfWCXFGsOtWG5kSGxol00Dwk94rIja6Q3JuIzeUyA'),
            'csrftoken': os.getenv('INSTAGRAM_CSRF_TOKEN', 'RWMuvgJnkfSn3NxCFDK02OTeqxGuerps'),
            'ds_user_id': os.getenv('INSTAGRAM_DS_USER_ID', '74709283824'),
            'ig_did': os.getenv('INSTAGRAM_IG_DID', 'E728DB53-9EA8-47EF-B90E-BF5E9FC95334')
        }
        self.user_agents = [
...
class TelegramHandler:
    def __init__(self):
        ...
        self.session_string = os.getenv('TELEGRAM_SESSION', '1AZWarzYBu6rnUxw9gornh-M0W9hrt-EsXujnNEuZMT5JnLQ0hEktsQIqzMfwTokfnLwN0q8rR89VB7x8Ik0MBVf4ebhLAb5HJ9fuChihJdYL6mxPM-VZM20ruWHjZzE55xFq8_PX0KwsJSB22eIp7WIUDuI-3TtoYoPBEl7I2izfy347dN-H2CHhC9ofUqER9qKFaeAOekQpSR3hJtGpxCxaApXg8asaediGtTiCsLIpk1m7p9aJPnKO4th169tzRzF_nqeiV_t2xqTtDT3CiROG-WSZQy51U7DmgFw4cEg3XBcxB3H23UONi0cVeDjB4LhQiDiWJoQf4GvdaER7bRQ2AWu8Lc0=')
