...
class Commands(Cog):
    ...
    @command(
        name="setxp", description="Set a user's experience", example=",setxp @kuzay 154"
    )
    @has_permissions(manage_guild=True)
    ...
    @command(
        name="setlevel", description="Set a user's level", example=",setlevel @kuzay 3"
    )
    @has_permissions(manage_guild=True)
