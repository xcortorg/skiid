"""
this was sent to me by yurrion who worked on greed which was apparently kayo? source (didn't fact check)
"""
...
class Feed:
    ...
    def __repr__(self: Self) -> str:
        state = "running" if self.tasks and not self.task.done() else "finished"
