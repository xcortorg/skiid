...
from discord import Client, Embed, File, User, Member, Guild, TextChannel, Thread, Color
...
class Commands(Cog):
    def __init__(self, bot: Client):
        ...
        self.bot.services.instagram.cookies_file = (
            "/root/bleed/www.instagram.com.cookies.json"
        )

    @group(
        name="twitter",
        description="lookup a twitter user or follow their timeline",
        example=",twitter threesome",
