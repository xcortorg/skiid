...
from discord import Embed, Message, Client, Member, User
from discord.ext.commands import Cog, CommandError, group, Boolean, has_permissions
from lib.classes.flags.antinuke import Parameters, get_parameters
from var.variables import dangerous_permissions
from lib.classes.models import Configuration
from var.config import CONFIG
from lib.classes.checks import trusted, guild_owner
...
class Commands(Cog):
    ...
    async def antinuke_botadd(
        self, ctx: Context, status: Boolean, *, flags: str = None
    ) -> Message:
        """
