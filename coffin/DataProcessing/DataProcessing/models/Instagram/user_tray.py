...
class MusicMetadata(BaseModel):
    music_canonical_id: Optional[int] = None
...
class OriginalSoundInfo(BaseModel):
    ...
    ig_artist: Optional[UserElement] = None
...
class Caption(BaseModel):
    ...
    did_report_as_spam: Optional[bool] = None
    share_enabled: Optional[bool] = None
    user: Optional[CaptionUser] = None
    is_covered: Optional[bool] = None
    is_ranked_comment: Optional[bool] = None
    media_id: Optional[str] = None
    private_reply_status: Optional[int] = None
...
class CarouselMedia(BaseModel):
    ...
    image_versions2: Optional[CarouselMediaImageVersions2] = None
...
class Item(BaseModel):
    ...
    likers: Optional[List[UserElement]] = None
    is_comments_gif_composer_enabled: Optional[bool] = None
    image_versions2: Optional[ItemImageVersions2] = None
    original_width: Optional[int] = None
    original_height: Optional[int] = None
...
class InstagramUserTrayResponse(BaseModel):
    ...
    items: Optional[List[InstagramPostResponse]] = None
