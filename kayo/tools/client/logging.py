...
class swagRichHandler(RichHandler):
    ...
    def emit(self, record: LogRecord) -> None:
        ...
        if (
            ...
            traceback = swagTraceback.from_exception(
                exc_type,
                exc_value,
                exc_traceback,
...
def init_logging(level: int) -> None:
    ...
    stdout_handler = swagRichHandler(
