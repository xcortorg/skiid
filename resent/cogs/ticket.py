...
class CreateTicket(discord.ui.View):
    ...
    async def create(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if len(results) == 0:
            ...
            embed.set_footer(
                text="resent.dev", icon_url=interaction.client.user.display_avatar.url
            )
            await interaction.client.db.execute(
        ...
        async def select_callback(inte: discord.Interaction):
            ...
            e = discord.Embed(
                ...
                title=f"<:rename:1209076697324986378> {select.values[0]}",
                description="Support will be with you shortly, please be patient.\n\nTo close the ticket press the button down below.",
            )
            e.set_footer(
                text="resent.dev", icon_url=interaction.client.user.display_avatar.url
...
class DeleteTicket(discord.ui.View):
    ...
    @discord.ui.button(
        label="",
        emoji="<:trash:1209432918523645983>:ren",
        style=discord.ButtonStyle.gray,
...
class tickets(commands.Cog):
    ...
    async def send(self, ctx: commands.Context):
        ...
        await self.bot.db.execute(
            ...
            self.bot.color or message.embeds[0].color.value,
            ctx.guild.id,
        )
