        ...
        async with aiohttp.ClientSession() as session:
            for emoji in interaction.guild.emojis:
                ...
                try:
                    ...
                    embed = discord.Embed(
                        color=interaction.client.color,
                        description=f"{interaction.client.no} {interaction.user.mention}: unable to add emojis - {error}",
                    )
...
async def steal_sticker(interaction: discord.Interaction, message: discord.Message):
    ...
    if not message.stickers:
        return await interaction.response.send_message(
            embed=discord.Embed(
                color=interaction.client.color,
                description=f"{interaction.client.no} {interaction.user.mention}: this message doesnt have any sticker",
            ),
            ephemeral=True,
        )
    try:
...
async def grab_sticker(interaction: discord.Interaction, message: discord.Message):
    ...
    if len(options) == 0:
        return await interaction.response.send_message(
            embed=discord.Embed(
                color=interaction.client.color,
                description=f"{interaction.client.no} {interaction.user.mention}: you cant add this sticker anywhere",
            ),
            ephemeral=True,
        )
    embed = discord.Embed(
