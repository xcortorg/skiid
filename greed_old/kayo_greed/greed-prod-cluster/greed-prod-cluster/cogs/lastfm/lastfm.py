...
class Lastfm(Cog):
    ...
    @app_commands.describe(
        member="The member whose current playing status you want to check"
    )
    ...
    async def spotify_slash(
        self, interaction: Interaction, query: Optional[str] = None
    ):
        """
    ...
    async def nowplaying(
        ...
        *,
        ...
        try:
            view = script.view if script and script.view else None
